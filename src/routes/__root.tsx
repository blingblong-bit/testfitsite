...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A serious gym in Tullahoma, Tennessee. Memberships, personal training, premium equipment, and 24/7 access. Built for athletes and beginners alike." },
      { name: "author", content: "FIT Beyond Plus" },
      { property: "og:title", content: "FIT Beyond Plus — More Than A Gym" },
      { property: "og:description", content: "A serious gym in Tullahoma, Tennessee. Train with intent." },
