...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "FIT Beyond Plus | Gym, Fitness Classes & Training in Tullahoma, TN" },
      { name: "author", content: "FIT Beyond Plus" },
      { property: "og:title", content: "FIT Beyond Plus — More Than A Gym | Tullahoma, TN" },
      { property: "og:description", content: "FIT Beyond Plus | Gym, Fitness Classes & Training in Tullahoma, TN" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FIT Beyond Plus — More Than A Gym | Tullahoma, TN" },
