...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FIT Beyond Plus | Gym, Classes & Personal Training in Tullah" },
      ...
      { property: "og:title", content: "FIT Beyond Plus | Gym, Classes & Personal Training in Tullah" },
      ...
      { name: "twitter:title", content: "FIT Beyond Plus | Gym, Classes & Personal Training in Tullah" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/jqENWZ4ZZDRMrCPTaFQeFYFDY1p1/social-images/social-1783056485486-ChatGPT_Image_Jul_3,_2026,_12_27_42_AM.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/jqENWZ4ZZDRMrCPTaFQeFYFDY1p1/social-images/social-1783056485486-ChatGPT_Image_Jul_3,_2026,_12_27_42_AM.webp" },
